    ...
    <div class="_fc-top">
      <div class="_fc-top-nav">
        <div class="_fc-top-copyright">
          ...
          <div class="_fc-t-name"><span>FcDesigner(Vue2)</span></div>
        </div>
        <div class="_fc-top-link">
          ...
          <a href="https://github.com/xaboy/form-create-designer" target="_blank"
            class="item">查看源码</a>
        </div>
      </div>
    </div>
    <fc-designer ref="designer" :key="lang" :config="config" :handle="handle" :locale="locale"
      :filedList="filedList" :fetchDictConfig="fetchDictConfig">
      <template #handle>
        <div class="handle">
...
export default {
  ...
  data() {
    return {
      ...
      fetchDictConfig: {
        fetchAction: "http://localhost:8080/system/dict/type/getOptionsDictByType",
        dictList: [
          {
            value: "sys_user_sex",
            label: "性别",
